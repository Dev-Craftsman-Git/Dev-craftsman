        ...
        <div className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <StatCard
                    ...
                    color="text-blue-500"
                    bg="bg-blue-500/10"
                    href="/devadmin/dwarakadmin/mylogin/projects"
                />
                <StatCard
                    title="Pricing Plans"
                    ...
                    bg="bg-green-500/10"
                    href="/devadmin/dwarakadmin/mylogin/pricing"
                />
                <StatCard
                    ...
                    bg="bg-purple-500/10"
                    href="/devadmin/dwarakadmin/mylogin/submissions"
                />
            </div>
            ...
            <div>
                <div className="flex items-center justify-between mb-4">
                    ...
                    <Link href="/devadmin/dwarakadmin/mylogin/submissions" className="text-sm text-primary hover:underline flex items-center">
